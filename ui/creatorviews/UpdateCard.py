...
class UpdateCard(tkinter.Frame):
    def __init__(self, selectedDeck, card, master=None):
        ...
        self.str_line = "_" * 20
        self.str_deck = tkinter.Label(text="Update card of deck : "+self.selectedDeck.name)
        ...
        self.var_title_entry.set(self.card.title)
        ...
        self.var_quest_entry.set(self.card.question)
        ...
        self.var_answer_entry.set(self.card.answer)
        self.answer_entry = tkinter.Entry(self.form_three, textvariable=self.var_answer_entry)

        self.save_btn = tkinter.Button(self.frame_menu, text="Save", command=self.update_card)
    ...
    def update_card(self):
        ...
        self.deckService.update_card_in_deck(self.selectedDeck, card, self.card)
        self.load_back_view()
